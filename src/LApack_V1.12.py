...
tab1_scroll = ttk.Scrollbar(tab1_container, command=tab1_canvas.yview)
tab1_canvas.config(yscrollcommand=tab1_scroll.set, height='13.7c')
tab1_scroll.grid(column=1, row=0, sticky='ns', rowspan=100)
...
ttk.Checkbutton(tab5, text="Mute Error Bar", variable=CheckVar1,
                onvalue=1, offvalue=0,  # height=0, standard Checkbutton only, ttk.Checkbutton doesn't allow height
